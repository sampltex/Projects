    ...
    for i in range(40):
        ...
        if line_circle_collision(line_start, line_end, circle_center, circle_radius):
            ...
            if posx > 768:
                ...
                # pygame.draw.line(screen, (255, 255, 255), (posy+startVal,posx-1000), (newposy,newposx), 3)
                print(newposx)
                print(newposy)
            else:
                pygame.draw.line(screen, (255, 255, 255), (newposx,newposy), line_end, 3)
                #  pygame.draw.line(screen, (255, 255, 255), (newposy,newposx), (posy-endVal,posx-1000), 3)
                print(newposx)
                print(newposy)
        else:
            pygame.draw.line(screen, (255, 255, 255), line_start, line_end, 3)
            #pygame.draw.line(screen, (255, 255, 255), (posy+startVal,posx-1000), (posy-endVal,posx-1000), 3)
